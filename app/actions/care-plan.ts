  ...
  await db.$transaction(async (tx) => {
    await tx.carePlan.update({
      ...
      data: {
        ...
        disasterDmeNeedsProviderChecked: bool(formData, "disasterDmeNeedsProviderChecked"),
        disasterTransportationCo: str(formData, "disasterTransportationCo"),
        disasterTransportationCoChecked: bool(formData, "disasterTransportationCoChecked"),
        disasterMedicationPickup: str(formData, "disasterMedicationPickup"),
        disasterMedicationPickupChecked: bool(formData, "disasterMedicationPickupChecked"),
        disasterHomeHealthAgency: str(formData, "disasterHomeHealthAgency"),
        disasterHomeHealthAgencyChecked: bool(formData, "disasterHomeHealthAgencyChecked"),
        disasterServiceAnimalsCare: str(formData, "disasterServiceAnimalsCare"),
        disasterServiceAnimalsCareChecked: bool(formData, "disasterServiceAnimalsCareChecked"),
        hasEmergencyContactsList: bool(formData, "hasEmergencyContactsList"),
        hasEmergencyContactsListText: str(formData, "hasEmergencyContactsListText"),
