  ...
  for (let i = 0; i < memberSeeds.length; i++) {
    ...
    await db.hraAssessment.create({
      data: {
        ...
        screenings: {
          create: [
            { toolName: "EPDS", score: seed.highRisk ? "14" : "4", riskLevel: seed.highRisk ? "High" : "Low", completedAt: new Date() },
            { toolName: "PREGNANCY_RISK", score: "Moderate", riskLevel: seed.highRisk ? "High" : "Low", completedAt: new Date() },
            { toolName: "SDOH", riskLevel: i % 4 === 0 ? "High" : "Low", notes: i % 4 === 0 ? "3 risks identified" : undefined, completedAt: new Date() },
            { toolName: "ASSIST", riskLevel: "Low", completedAt: new Date() },
            { toolName: "HITS", riskLevel: "Negative", completedAt: new Date() },
          ],
        },
      },
    });
