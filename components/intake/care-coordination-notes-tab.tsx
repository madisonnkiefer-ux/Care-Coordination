      ...
      <Card title="Summary">
        <OrderedStack
          ...
          items={[
            ...
            {
              key: "ccn.behavioralHealthSummary",
              el: (
                <TextArea
            ...
            {
              key: "ccn.safetyVisionHearingCaregiverObservations",
              el: (
                <TextArea
            ...
            {
              key: "ccn.hrsnAndAdditionalObservations",
              el: (
                <TextArea
            ...
            {
              key: "ccn.communityProviderReferrals",
              el: (
                <TextArea
            ...
            {
              key: "ccn.schedulingAssistanceProvided",
              el: (
                <TextArea
      ...
      <Card title="6. Per comprehensive needs assessment, member meets criteria for:">
        <OrderedStack
          ...
          items={[
            ...
            {
              key: "ccn.cannotBeLeveledDownIndicators",
              el: (
                <div className="border-t border-stone-100 pt-4">
                  <p className="mb-2 text-sm font-semibold text-stone-700">*Members with the below indicators may not be leveled down.</p>
                  <CheckboxGroup
      ...
      <Card>
        <OrderedStack
          ...
          items={[
            ...
            {
              key: "ccn.eligibilityConclusionsSummary",
              el: (
                <TextArea
            ...
            {
              key: "ccn.hcbsSettingsRuleAssessed",
              el: (
                <YesNoNaField
            ...
            {
              key: "ccn.providedServicesBenefitsInfo",
              el: (
                <div>
                  <YesNoField
            ...
            {
              key: "ccn.memberSatisfactionDescription",
              el: (
                <TextArea
            ...
            {
              key: "ccn.complexCaseManagementOrNfloc",
              el: (
                <SelectField
