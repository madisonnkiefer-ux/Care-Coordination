const wordmarkFont = "var(--font-bodoni), 'Times New Roman', serif";
...
export function AvanzaLogo({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 420 260" className={className} xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Avanza Care">
      ...
      <text x="210" y="150" textAnchor="middle" fontFamily={wordmarkFont} fontSize="165" fontWeight="500" fill="#1c1917">
        A
      </text>
      ...
      <text x="210" y="200" textAnchor="middle" fontFamily={wordmarkFont} fontSize="32" fontWeight="500" letterSpacing="11" fill="#1c1917">
        AVANZA CARE
      </text>

      <line x1="195" y1="217" x2="225" y2="217" stroke="#a15a72" strokeWidth="2" />

      <text x="210" y="237" textAnchor="middle" fontFamily={wordmarkFont} fontSize="12" letterSpacing="4" fill="#a8917f">
